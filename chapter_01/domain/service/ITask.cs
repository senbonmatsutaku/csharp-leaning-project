...
namespace chapter_01.domain.service
{
    ...
    {
        // 問１
        // C# WikipediaのサイトからC#の仕組みをコンソールに出力せよ。
        // なお、出力する文章は「C#は共通言語基盤～～による実行の高速化、などが実現されている（もっともこれらはC#の機能というより.NET Frameworkによるものである）。」の部分とする。
        // url: https://ja.wikipedia.org/wiki/C_Sharp
        void LearnCsharpMechanism();
